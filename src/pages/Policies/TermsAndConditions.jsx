  ...
  return (
    <div className="w-full px-4 md:px-8 xl:px-20 py-6">
      ...
      <div className="w-full flex flex-col items-start gap-4">
        ...
        <h2 className="font-bold blue-text text-[28px] mt-4">
        ...
        <p>
          ...
          upon, in person at a location convenient for all parties. <br />
          <br />
          ...
          first using the App. You opt-out notice must include your name,
